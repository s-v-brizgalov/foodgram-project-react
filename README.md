# Foodgram
---
![workflow](https://github.com/s-v-brizgalov/foodgram-project-react/actions/workflows/foodgram_workflow.yml/badge.svg)
...
1. Клонируйте проект:
```
git clone https://github.com/s-v-brizgalov/foodgram-project-react.git
```
